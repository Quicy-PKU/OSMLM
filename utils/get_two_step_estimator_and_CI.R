get_two_step_estimator_poisson = function (get_h0, get_h, beta0_initial, beta_initial, full_data, n0, n, model_type, sampling_type, rho=0, H=NULL, r1=0, r2=0, r3=0, flag=T) {
    tryCatch(
        expr = {
            ...
            return (list(get_MLE(get_h0, get_h, beta0_initial, beta_initial, rbind(pilot_data, full_data[idx, ]), model_type, c(rep((n0+n)/N, nrow(pilot_data)), (n0+n) / n * w[idx])), w, idx, pilot_idx))
        },
        error = function (e) {
            print(e)
        }
